...
# Spanish team names — indices 0-62 = national/allstar, 63-94 = ML teams
_TEAM_NAMES = [
    # National teams (0-53)
    "Irlanda",
    "Escocia",
...
def generate_spanish_ppf(assets_dir: str = "") -> bytes:
    ...
    if assets_dir:
        ...
        menu = get_menu_records(assets_dir, "es")
        if menu:
            records = menu + records  # team names written AFTER menus (override)
    return _make_ppf1("WE2002 Spanish - Console Utilities", records)
