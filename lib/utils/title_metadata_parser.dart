...
class TitleMetadataParser {
  ...
  static final List<_PatternHandler> _patterns = [
    ...
    _PatternHandler(RegExp(r'^\d{5,8}\s*[-–]?\s*Disc(?:,|\b)', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
    _PatternHandler(RegExp(r'^\d{5,8}\s*[-–]?\s*CAT(?:-|\b)', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
    _PatternHandler(RegExp(r'^(?:DISC,\s*CAT)', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
    ...
    _PatternHandler(RegExp(r'\(iam8bit\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Animal Crossing\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Piko Interactive\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Capcom Town\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(e-Reader Edition\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Kiosk\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Switch\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Retro-Bit\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Retro-Bit Generations\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Genesis Mini\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Sega Channel\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\Classic(s)? Collection\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(LodgeNet\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(HAL Laboratory\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Broke Studio\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Metal Gear Solid Collection\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(The Cowabunga Collection\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Switch Online\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Wii Virtual Console\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Wii U Virtual Console\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(GameCube\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(GameCube Edition\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Limited Run Games\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Strictly Limited Games\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Columbus Circle\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Sega Reactor\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Evercade\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Not for Resale\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Intellivision Lives!\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Alt\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Arcade\)'), (match, context) { context.distributionTypes.add(DistributionType.alternate); context.categories.add('Arcade'); }, stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Arcade CD-ROM\)'), (match, context) { context.distributionTypes.add(DistributionType.alternate); context.categories.add('Arcade'); }, stripFromTitle: false),
    ...
    _PatternHandler(RegExp(r'\(Trade Demo\)'), (match, context) => context.romTypes.add(RomType.demo)),
    _PatternHandler(RegExp(r'\(Demo\)'), (match, context) => context.romTypes.add(RomType.demo)),
    _PatternHandler(RegExp(r'Demo\)'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'Demo CD'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'Demo Disc'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'Demo Action Pack'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'Demo Pack'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'Playable Demo'), (match, context) => context.romTypes.add(RomType.demo), stripFromTitle: false),
    _PatternHandler(RegExp(r'\(Sample\)'), (match, context) => context.romTypes.add(RomType.sample)),
    _PatternHandler(RegExp(r'\(Promo\)'), (match, context) => context.romTypes.add(RomType.sample)),
    ...
    _PatternHandler(RegExp(r'\((?:Rev|REV|rev|RE)[ -]?([A-Z\d]+)\)'), (match, context) => context.revision = match.group(1) ?? '1'),
    ...
    _PatternHandler(RegExp(r'\(v([\d\.]+)\)'), (match, context) => context.revision = match.group(1) ?? '1'),
    _PatternHandler(RegExp(r'\(Version ([\d\.]+)\)', caseSensitive: false), (match, context) => context.revision = match.group(1) ?? '1'),
    ...
    _PatternHandler(RegExp(r'^\d+\.\d+\s+IDU.*', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
    _PatternHandler(RegExp(r'^Cleaning Kit for .+', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
    _PatternHandler(RegExp(r'Test Cartridge', caseSensitive: false), (match, context) => context.romTypes.add(RomType.bios), stripFromTitle: false),
...
class _PatternHandler {
  ...
  final bool stripFromTitle;
  
  const _PatternHandler(this.regex, this.handler, {this.stripFromTitle = true});
}
